  ...
  return (
    <div className="min-h-screen font-sans" style={{ backgroundColor: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <section className="flex flex-col items-center justify-center h-screen text-center px-8">
        <h2 className="text-5xl font-light mb-4">Full Stack Developer</h2>
        <h3 className="text-2xl font-light mb-5">
          {/* (website in W.I.P. for more info see my{' '}
          <a href="https://www.linkedin.com/in/marco-battisti-kb4/" style={{ color: 'var(--text-muted)' }} className="hover:text-white">
            LinkedIn
          </a>) */}
        </h3>
        ...
        <Link
          href="/projects"
          className="mt-8 px-6 py-3 rounded transition"
          style={{
